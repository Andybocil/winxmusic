...
from AmonMusic.utils.database import get_authuser_names, get_cmode
from AmonMusic.utils.decorators import ActualAdminCB, AdminActual, language
from AmonMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Amon.stop_stream(message.chat.id)
    except:
        pass
