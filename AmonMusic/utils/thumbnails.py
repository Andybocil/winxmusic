...
async def gen_thumb(videoid):
    ...
    arial = ImageFont.truetype("assets/thumb/font2.ttf", 30)
    font = ImageFont.truetype("assets/thumb/font.ttf", 30)
    title_font = ImageFont.truetype("assets/thumb/font3.ttf", 45)
    ...
    play_icons = Image.open("assets/thumb/play_icons.png")
